...
export function NamespacePage(props: {page: Page}) {
	if(props.page.Type != 'Namespace') {
		return (
			<div>
				error: page is not a namespace
			</div>
		)
	}
	...
	return (
		<PageWithHeader VersionIntroduced={VersionIntroduced} Icon={NamespaceIcon} Title={props.page.UnqualifiedName} Color={Theme.code.Namespace.color} >
			<PageHeaderExtraInfo>
				<div
					style={{
						color: 'white',
